...
1- سبام أكثر من ٥ رسائل سواء رساله او صوره او ستكر.

2- إرسال أكثر من 20
[صورة، فيديو، صوتي، GIF] .

3- الأغاني سواء في فيديو او رسائل صوتيه او تسجيل.

4- صور للجنس الآخر خارج الانمي.

5- التحدث عن الجنس الآخر بأي حال من الأحوال لسبب غير لائق.

6- التحدث بمواضيع دينيه أو سياسيه. 

7- الإعتداء اللفظي بدون ميانه.

8- طلب إشراف.

9- تغيير لقبك بدون إذن المشرفين.

10- التشفير.

11- الإعتراض على إنذار في القروب.

12- ارسال مقطع أو صورة خلال المسابقات والفعاليات.

13- إزعاج الأعضاء أو المشرفين.

14- التحدث عن حلقه قبل مرور 8 ساعات من نزولها.
...
1- إرسال صور غير محتشمه لأي جنس.

2- الحرق الغير متعمد.

3- إرسال صورة شخصية👤.

4- إفتعال مشاكل متعمدا مع فانز انمي او مسلسل او مشعجين كرة قدم الخ.

5- التنمر او العنصرية بجميع انواعها🗣️.

6-سرقة الأعضاء 👥.

7- نشر محادثات الخاص.

8- التحريض على المملكة 🏯.

❃━═━═✦•♾•✦═━═━❃


‏主 مخالفات الطرد المؤبد❗.

1- تغيير الجنس (ولد او بنت).

2- القذف بأي شكل من اشكاله.

3-الحرق المتعمد بالعام أو بالخاص🔥.

4- التحدث عن الإديان الاخرى بالسوء او النقد ❌.

5- التحدث عن الشواذ بكل أنواعة و يمنع إرسال العلم [ 🏳️‍🌈 ] .
...
1- يسمح لأصحاب الرتب العليا تنفيذ قوانين غير موجودة ضمن التي ذكرت في بعض الحالات.

2- يتم خصم 30k على كل إنذار.

3- يمكن حذف الإنذار عن طريق المتجر.

4- كل ٣ إنذارات = طرد ٣ أيام.

5- يسمح لأصحاب الرتب العليا باستعمال الطرد التأديبي لمدة يتم تحديدها حسب سبب العقوبة.
...
• رسم - تصميم الـخ.. 
*❆━━─ •༺ ☣️ ༻• ─━━❆*
*◈صورة للشخصيه يلي اخترت اسمه*


*ملاحظة 🛑: ممنوع ولد ياخذ لقب بنت او بنت تاخذ لقب ولد.
...
❃━═━═✦•☣️•✦═━═━❃
✧︎ روابط مهمة يجب الإطلاع عليها :

✦︎ القوانين ←︎  https://cutt.us/Shir09

✦︎ الإعلانات ︎←︎ https://cutt.us/Shir01
...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `انضمو الأستقبال لأهنتو`,unicorn, [{"urlButton": {"displayText": "「 قناتي 」「📍」◣","url": `${myweb}`}},{"urlButton": {"displayText": "「 رابط الاستقبال 」「📌」◣","url": `${sc}`}},{"quickReplyButton": {"displayText": "「 الاستلام 」「🍜」◣","id": 'donate'}},{"quickReplyButton": {"displayText": "「 المالك 」「👤」◣","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
